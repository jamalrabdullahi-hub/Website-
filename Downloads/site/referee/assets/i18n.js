...
var DICT = {
  ...
  "Lambarkaaga taleefanku waa akoonkaaga. Iimayl ma jiro, eray sir ah oo la illoobo ma jiro — lambarkaaga iyo PIN kaliya.":
    "Your phone number is your account. No email, no password to forget — just your number and a PIN.",
  ...
  "oo hel dheeraad markuu wax qaato.": "and get credit when they collect.",
  "Xogtaada": "Your details", "Magaca": "Name", "Cinwaanka gaarsiinta": "Delivery address",
  "Habka lacag bixinta": "Payment method", "Lambarka lacag bixinta": "Payment number",
  "Xogtan waxaa loo isticmaalaa dalabkaaga oo keliya. Cidna lama siiyo.":
    "These details are only used for your orders. They are never shared.",
  "Dheeraadkaaga": "Your credit", "Si toos ah ayaa looga jaraa dalabkaaga xiga.": "It comes off your next order automatically.",
  "Koodhka casuumaadda": "Your invite code",
  "Marka saaxiibkaa qaato dalabkiisa koowaad waxaad heshaa dheeraad; isna wuxuu helayaa 5% dhimis.":
    "When your friend collects their first order you get credit; they get 5% off.",
  "Ku wadaag WhatsApp": "Share on WhatsApp", "Ammaanka": "Security", "Beddel PIN-ka": "Change PIN",
  "PIN-ka hadda": "Current PIN", "PIN cusub (4–6 lambar)": "New PIN (4–6 digits)",
  "Haddii aad taleefanka lumiso, nala soo xidhiidh — waan hakin karnaa akoonka.":
    "If you lose your phone, contact us — we can suspend the account.",
  "Kale": "More", "Dalabyadayda →": "My orders →", "Dambiisha →": "Cart →",
  "Garsoore Ganacsi →": "Garsoore Business →", "Garsoore (suuqa) →": "Garsoore (market) →",
  "⚙ Hawlgalka →": "⚙ Operations →", "🛡 Console →": "🛡 Console →",
  "🔒 PIN-kaaga cid kale ha u sheegin. Shaqaalaha Garsoore weligood kuma weydiin doonaan.":
    "🔒 Never tell anyone your PIN. Garsoore staff will never ask for it."
